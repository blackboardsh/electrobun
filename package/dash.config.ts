...
export default {
	scripts: {
		...
		"dev:canary": "npm install && dash build:release && cd ../kitchen && npm install && dash electrobun build --env=canary",
		"dev:stable": "npm install && dash build:release && cd ../kitchen && npm install && dash electrobun build --env=stable",
