				...
				<div class="bg-white rounded-xl p-8 mb-5 shadow-lg">
					...
					<ul class="space-y-3">
						<li class="flex items-start gap-2 text-gray-500">
							...
							Run <code class="bg-gray-100 px-2 py-0.5 rounded text-sm font-mono">hutch run dev</code> for development without HMR
						</li>
						<li class="flex items-start gap-2 text-gray-500">
							<span class="text-cyan-600 font-bold">2.</span>
							Run <code class="bg-gray-100 px-2 py-0.5 rounded text-sm font-mono">hutch run dev:hmr</code> for development with hot reload
						</li>
						<li class="flex items-start gap-2 text-gray-500">
							<span class="text-cyan-600 font-bold">3.</span>
							Run <code class="bg-gray-100 px-2 py-0.5 rounded text-sm font-mono">hutch run build:canary</code> to build a canary release
						</li>
					</ul>
				</div>
