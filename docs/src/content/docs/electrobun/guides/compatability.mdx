...
compatibility is separate from package management. npm, pnpm, Yarn, or Bun owns
the JavaScript dependency graph and lockfile; Hutch owns Electrobun builds,
versioned devkits, and compiler toolchains.
