...
prepare implicitly; use `hutch electrobun sync` when you deliberately want an
unpinned direct-Hutch project to follow the current release channel head. See
