...
Webviews can read files beneath `userData` through the opt-in `appdata://`
protocol; see [Local Webview Assets](/electrobun/apis/bundled-assets/#load-mutable-files-with-appdata).
