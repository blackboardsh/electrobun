...
async function copyToDist() {
    ...
    if (OS === 'macos') {
        ...
        await $`cp src/native/win/build/nativeWrapper.dll dist/nativeWrapper.dll`;
    } else if (OS === 'linux') {
...
async function buildNative() {
    if (OS === 'macos') {
        ...
        await $`link /DLL /OUT:src/native/win/build/nativeWrapper.dll /IMPLIB:src/native/win/build/nativeWrapper.lib src/native/win/build/nativeWrapper.obj`;
    } else if (OS === 'linux') {
